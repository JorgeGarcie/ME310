...
bool HardwareControl::lidOpen() {
  ...
  success &= suctionLidOn();           // Turn on suction
  delay(200);                          // Allow suction to build
  success &= lowerLidLifter();         // Lower to contact lid
  delay(500);                          // Allow suction to grab lid
  success &= raiseLidLifter();         // Lift lid away
